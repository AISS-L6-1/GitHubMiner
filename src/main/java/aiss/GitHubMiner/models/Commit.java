...
@JsonPropertyOrder({
        /*
    Propiedades que quiero -> [id (sha), tittle (no hay), message (en Commit_1), authorName (en Author),
    authorEmail (en Author), authoredDate (en Author),
    committerName (en Commiter), committerEmail (en Commiter), committedDate (en Commiter), webUrl (url)]
         */
    "sha", // <-- "sha" es el "id"
    "commit",
    "url",
